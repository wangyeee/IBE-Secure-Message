...
public class IBECSR implements Serializable {
	...
	public int hashCode() {
		...
		result = prime * result
				+ ((ibeSystemId == null) ? 0 : ibeSystemId.hashCode());
		result = prime * result
				+ ((identityString == null) ? 0 : identityString.hashCode());
		result = prime * result
	...
	public String toString() {
		return "IBECSR [requestId=" + requestId + ", identityString="
				+ identityString + ", password=" + password + ", ibeSystemId="
				+ ibeSystemId + ", applicationDate=" + applicationDate
				+ ", period=" + period + "]";
	}
}
